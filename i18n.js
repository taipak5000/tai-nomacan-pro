...
window.SKY_TRANSLATIONS = {
    ja: {
        ...
        "route.shareCopyFailedHint": "⚠️ クリップボードへの自動コピーに失敗しました。下の欄からコピーしてください。",
    ...
    en: {
        ...
        "route.shareCopyFailedHint": "⚠️ Couldn't copy automatically. Please copy it from the box below.",
